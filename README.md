...
npm run test:features             # 206 checks across every admin/candidate/assessor feature
```
...
python3 tests/features.py     # 206 checks: every feature — CRUD, validation, config editing,
